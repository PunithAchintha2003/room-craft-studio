...
export const DesignEditorPage: React.FC = () => {
  ...
  useEffect(() => {
    // Fetch furniture catalog for 3D preview
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh', bgcolor: 'background.default' }}>
        ...
        <Toolbar>
          ...
          <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
            ...
            <Button
              ...
              onClick={() => setView3DModalOpen(true)}
              sx={{ mr: 1 }}
            >
              3D Preview
            </Button>
      ...
      <Dialog
        open={view3DModalOpen}
        onClose={() => setView3DModalOpen(false)}
        maxWidth="lg"
        fullWidth
        PaperProps={{
          sx: {
      ...
      >
        <DialogTitle>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Typography variant="h6">3D Preview - {currentDesign.name}</Typography>
            <IconButton onClick={() => setView3DModalOpen(false)} size="small">
              <CloseIcon />
            </IconButton>
          </Box>
        </DialogTitle>
        ...
        <DialogActions>
          ...
          <Button onClick={() => setView3DModalOpen(false)}>Close</Button>
        </DialogActions>
      </Dialog>
    </Box>
  );
