...
/** Wall preset keys from RoomConfigForm */
...
/** Floor preset keys from RoomConfigForm */
...
/**
 * Returns a loadable URL for the given room texture value (preset key or custom URL).
 * Returns null if the value is empty or not a known preset / valid URL.
 */
