...
export const ExportDialog: React.FC<ExportDialogProps> = ({
  ...
  const estimatedFileSize =
    ((selectedResolution.width * selectedResolution.height * 3) / (100 - options.quality)) /
    1024 /
    1024;
      ...
      <DialogContent>
        ...
        <FormControl fullWidth sx={{ mb: 2 }}>
          ...
          <Select
            ...
            label="Resolution"
            onChange={(e) =>
              setOptions({ ...options, resolution: e.target.value as ExportOptions['resolution'] })
            }
          >
            <MenuItem value="low">
              <Box>
        ...
        <FormControlLabel
          control={
            <Checkbox
              ...
              onChange={(e) =>
                setOptions({ ...options, transparentBackground: e.target.checked })
              }
        ...
        <Box sx={{ p: 2, bgcolor: 'primary.50', borderRadius: 1 }}>
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mt: 1 }}>
            ...
            <Chip
              label={`~${estimatedFileSize.toFixed(1)} MB`}
              size="small"
              color="primary"
              variant="outlined"
            />
