...
export const MeasurementLayer: React.FC<MeasurementLayerProps> = ({
  ...
  const [measurements, setMeasurements] = useState<Array<{ start: MeasurementPoint; end: MeasurementPoint }>>([]);
  ...
  return (
    <>
      ...
      {/* Invisible rect to capture clicks */}
      {isActive && (
        <Group
          ...
          listening={isActive}
        >
          {/* This will be handled by parent Stage */}
        </Group>
      )}
    </>
  );
