      ...
      <DialogContent sx={{ pt: 2.5, color: 'text.primary' }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          >
            ...
            <ShortcutItem
              keys={['Delete']}
              description="Delete selected furniture"
              glass={glass}
              isDark={isDark}
            />
            <ShortcutItem
            ...
            <ShortcutItem
              keys={['Shift', 'Click']}
              description="Multi-select furniture"
              glass={glass}
              isDark={isDark}
            />
          ...
          >
            ...
            <ShortcutItem
              keys={['G']}
              description="Move (translate) selected furniture"
              glass={glass}
              isDark={isDark}
            />
            <ShortcutItem
              keys={['R']}
              description="Rotate selected furniture"
              glass={glass}
              isDark={isDark}
            />
            <ShortcutItem
              keys={['S']}
              description="Scale selected furniture"
              glass={glass}
              isDark={isDark}
            />
