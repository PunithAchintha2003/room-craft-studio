...
import { createDesignerTheme, DesignerThemeMode } from './theme';
...
const STORAGE_KEY = 'roomcraft_designer_theme_mode';
...
export const ThemeModeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const theme = useMemo(
    () => createDesignerTheme(resolvedMode as DesignerThemeMode),
    [resolvedMode]
  );
