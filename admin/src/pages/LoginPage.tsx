      ...
      >
        ...
        >
          ...
          <Chip
            ...
            label="Authorised Personnel Only"
            sx={{
              mb: 4,
          ...
          >
            Manage users, platform settings, and oversee all RoomCraft Studio operations
            from one place.
          </Typography>

          <Stack spacing={2.5}>
            {[
              { label: 'User & role management', color: theme.palette.primary.main },
              { label: 'Platform settings & configuration', color: '#3B82F6' },
              { label: 'Content & designer oversight', color: '#10B981' },
              { label: 'Analytics & reporting', color: '#8B5CF6' },
            ].map(({ label, color }) => (
      ...
      >
        ...
        >
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary' }}>
              Access the admin dashboard and platform controls
            </Typography>
          </Box>
          ...
          <Divider sx={{ my: 3, borderColor: alpha('#374151', 0.6) }} />
          ...
          >
            ...
            >
              This portal is restricted to authorised RoomCraft Studio admins only.
