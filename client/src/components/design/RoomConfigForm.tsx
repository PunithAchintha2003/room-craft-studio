      ...
      <Box component="div">
        <Stack spacing={3}>
          <Box>
            <Box display="flex" alignItems="center" gap={1}>
              ...
              <Tooltip
                ...
                title={
                  <Box sx={{ py: 0.5 }}>
                    <Typography variant="body2">Width: Min 1m, Max 20m</Typography>
                    <Typography variant="body2">Length: Min 1m, Max 20m</Typography>
                    <Typography variant="body2">Height: Min 2m, Max 5m</Typography>
                  </Box>
                }
                slotProps={{
                  tooltip: {
            ...
            <Grid container spacing={2} sx={{ mt: 0.5 }}>
              <Grid item xs={12}>
                <Controller
                  ...
                  rules={{ min: 1, max: 20 }}
                  render={({ field }) => (
                    <TextField {...field} label="Width" type="number" fullWidth size="small" inputProps={{ min: 1, max: 20, step: 0.1 }} />
                  )}
                />
              </Grid>
              <Grid item xs={12}>
                <Controller
                  ...
                  rules={{ min: 1, max: 20 }}
                  render={({ field }) => (
                    <TextField {...field} label="Length" type="number" fullWidth size="small" inputProps={{ min: 1, max: 20, step: 0.1 }} />
                  )}
                />
              </Grid>
              <Grid item xs={12}>
                <Controller
                  ...
                  rules={{ min: 2, max: 5 }}
                  render={({ field }) => (
                    <TextField {...field} label="Height" type="number" fullWidth size="small" inputProps={{ min: 2, max: 5, step: 0.1 }} />
                  )}
                />
              </Grid>
            </Grid>
                ...
                <FormControl fullWidth size="small">
                  <Select
                    ...
                    renderValue={(v) => {
                      ...
                      return labels[v as RoomLayout] ?? String(v);
                    }}
                  >
              ...
              <Grid container spacing={2}>
                        ...
                        <Select
                          ...
                          value={
                            layout === 't-shape' || layout === 'u-shape'
                              ? cornerPositions.includes((field.value as CutoutPosition) ?? '')
                                ? 'bottom'
                                : field.value ?? 'bottom'
                              : sidePositions.includes((field.value as CutoutPosition) ?? '')
                                ? 'bottom-right'
                ...
                <Grid item xs={12}>
                  <Controller
                    ...
                    rules={{ min: 0.5 }}
                    render={({ field }) => (
                      <TextField {...field} label="Cutout width (m)" type="number" fullWidth size="small" inputProps={{ min: 0.5, max: 30, step: 0.1 }} />
                    )}
                  />
                </Grid>
                <Grid item xs={12}>
                  <Controller
                    ...
                    rules={{ min: 0.5 }}
                    render={({ field }) => (
                      <TextField {...field} label="Cutout length (m)" type="number" fullWidth size="small" inputProps={{ min: 0.5, max: 30, step: 0.1 }} />
                    )}
                  />
                </Grid>
              </Grid>
          ...
          <Box>
            ...
            <HexColorPicker color={wallColor} onChange={(color) => setValue('wallColor', color)} style={{ width: '100%', height: 150 }} />
            <TextField value={wallColor} onChange={(e) => setValue('wallColor', e.target.value)} size="small" fullWidth sx={{ mt: 1 }} />
          </Box>
          ...
          <Box>
            ...
            <HexColorPicker color={floorColor} onChange={(color) => setValue('floorColor', color)} style={{ width: '100%', height: 150 }} />
            <TextField value={floorColor} onChange={(e) => setValue('floorColor', e.target.value)} size="small" fullWidth sx={{ mt: 1 }} />
          </Box>
          ...
          <Box>
            ...
            <FormControl fullWidth size="small">
              ...
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <Select {...field} value={field.value || ''} labelId="wall-texture-label" label="Preset">
                    ...
                    {field.value &&
                      !['wall-concrete', 'wall-brick', 'wall-plaster', 'wall-wallpaper'].includes(field.value) && (
            ...
            <TextField label="Custom Wall Texture URL" value={wallTexture || ''} onChange={(e) => setValue('wallTexture', e.target.value)} size="small" fullWidth sx={{ mt: 1 }} />
            <Controller
              name="wallTextureScale"
              control={control}
              render={({ field }) => (
                <TextField {...field} label="Wall Texture Tiling" type="number" fullWidth size="small" sx={{ mt: 1 }} inputProps={{ min: 0.1, max: 10, step: 0.1 }} />
              )}
            />
          </Box>
          ...
          <Box>
            ...
            <FormControl fullWidth size="small">
              ...
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <Select {...field} value={field.value || ''} labelId="floor-texture-label" label="Preset">
                    <MenuItem value="">None (Color Only)</MenuItem>
                    ...
                    {field.value &&
                      !['floor-wood-light', 'floor-wood-dark', 'floor-tile', 'floor-carpet'].includes(field.value) && (
                        <MenuItem value={field.value}>Custom (from URL)</MenuItem>
                      )}
                  </Select>
                )}
            ...
            <TextField label="Custom Floor Texture URL" value={floorTexture || ''} onChange={(e) => setValue('floorTexture', e.target.value)} size="small" fullWidth sx={{ mt: 1 }} />
            <Controller
              name="floorTextureScale"
              control={control}
              render={({ field }) => (
                <TextField {...field} label="Floor Texture Tiling" type="number" fullWidth size="small" sx={{ mt: 1 }} inputProps={{ min: 0.1, max: 10, step: 0.1 }} />
              )}
            />
          </Box>
                  ...
                  <Grid container spacing={2}>
                      ...
                      <Controller
                        ...
                        render={({ field: openingField }) => (
                          <FormControl fullWidth size="small">
                            ...
                            <Select {...openingField} labelId={`opening-type-label-${index}`} label="Type">
                      ...
                      <Controller
                        ...
                        render={({ field: openingField }) => (
                          <FormControl fullWidth size="small">
                            ...
                            <Select {...openingField} labelId={`opening-wall-label-${index}`} label="Wall">
                    ...
                    <Grid item xs={6}>
                      <Controller
                        ...
                        control={control}
                        render={({ field: openingField }) => (
                          <TextField {...openingField} label="Width (m)" type="number" size="small" fullWidth inputProps={{ min: 0.3, max: 5, step: 0.1 }} />
                        )}
                      />
                    </Grid>
                    <Grid item xs={6}>
                      <Controller
                        ...
                        control={control}
                        render={({ field: openingField }) => (
                          <TextField {...openingField} label="Height (m)" type="number" size="small" fullWidth inputProps={{ min: 0.3, max: 5, step: 0.1 }} />
                        )}
                      />
                    </Grid>
                    <Grid item xs={6}>
                      <Controller
                        ...
                        control={control}
                        render={({ field: openingField }) => (
                          <TextField {...openingField} label="Bottom (m from floor)" type="number" size="small" fullWidth inputProps={{ min: 0, max: 5, step: 0.1 }} />
                        )}
                      />
                    </Grid>
                    <Grid item xs={6}>
                      <Controller
                        ...
                        control={control}
                        render={({ field: openingField }) => (
                          <TextField {...openingField} label="Offset along wall (m)" type="number" size="small" fullWidth inputProps={{ min: 0, step: 0.1 }} />
                        )}
                      />
                    </Grid>
                  </Grid>
